<template>
  <v-container class="content-padding">
    <v-row>
        <v-col>
              <h1 class="pb-10 text-center">Политика конфинденциальности</h1>
              <p>
                ...
                10.3 Настоящее согласие действует до момента его отзыва путем направления соответствующего уведомления на электронный адрес studio@marketolog.sale. В случае отзыва мною согласия на обработку персональных данных Оператор вправе продолжить обработку персональных данных без моего согласия при наличии оснований, указанных в пунктах 2 – 11 части 1 статьи 6, части 2 статьи 10 и части 2 статьи 11 Федерального закона №152-ФЗ «О персональных данных» от 27.06.2006 г.<br>
              </p>
        </v-col>
    </v-row>
  </v-container>
...
export default {
  head () {
      ...
      meta: [
          { charset: 'utf-8' },
          { hid: 'description', name: 'description', content: 'Политика конфиденциальности - Продажа китайской спецтехники XCMG по России от официального дилера.'},
