    ...
    data() {
        return {
            ...
            slides: [{
                ...
                title: 'SHACMAN <br/>При покупке 1 единицы скидка на следующую единицу 200&nbsp;тыс.&nbsp;руб.',
                notes: [
                    "*Акция действует до 31 августа 2024г.",
                    'Подробности узнавайте у менеджеров компании KOMTRANS Group'
                ]
            },{
                image: '/img/main-window/akciya-shacman-2.webp',
                title: 'СЕРВИС SHACMAN <br/>Замена лобового стекла - 1000&nbsp;руб.',
                notes: [
                    "*Акция действует до 31 августа 2024г.",
                    'Подробности узнавайте у менеджеров компании KOMTRANS Group'
                ]
