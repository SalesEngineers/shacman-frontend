            ...
            <v-row align="center" class="block-padding">
                <v-col cols="12" lg="6">
                    <div class="mr-xl-9 mr-lg-4">
                        ...
                        <p>Компания основана в 2009 году и на протяжении многих лет успешно реализует технику Shacman. За время работы открыто более 20 филиалов по всей стране, собственные сервисные центры и склад запасных частей для грузовых автомобилей. В штате компании 30 выездных бригад для обслуживания грузовой техники по месту её работы.</p>
            ...
            <div class="block-padding">
                ...
                <client-only>
                    <div class="svg-map-container">
                        <div class="svg-title">
                            <div class="svg-title-number">20</div>
                            <div class="svg-title-content">филиалов <br/>по России</div>
                        </div>
