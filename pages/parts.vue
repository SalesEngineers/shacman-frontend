<template>
    <div>
        <MainWindow :slides="[{image: '/img/parts/slide-1.jpg', title: 'Оригинальные запчасти для грузовой техники Shacman', tag: 'h1', btnTitle: '', link: ''}]"/>
                ...
                <v-col cols="12" lg="6">
                    <div class="mr-xl-9 mr-lg-4">
                        <h2 class="text-uppercase mb-md-14 mb-9">
                            Запчасти <br class="d-none d-lg-inline">для грузовой техники   
                        </h2>
