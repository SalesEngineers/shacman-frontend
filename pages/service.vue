<template>
    <div>
        <MainWindow
            :slides="[
                {
                    title: 'Сервисное обслуживание грузовой техники Shacman в Красноярске',
        ...
        <div class="content-padding pb-0">
            <v-container>
                <v-row
                    class="align-center block-padding flex-row flex-md-row-reverse"
                >
                    <v-col cols="12" md="6">
                        <client-only>
                            <iframe
                                loading="lazy"
                                class="video mb-8 mb-md-0"
                                src="https://www.youtube.com/embed/XxR2MIly3ZE"
                    ...
                    <v-col cols="12" md="6">
                        <p class="mb-5 mb-md-8 mb-xl-11">
                            Транспортировка и&nbsp;отрыв техники
                            от&nbsp;производства больше не&nbsp;требуются:
                            мобильная бригада &laquo;KOMTRANS Group&raquo;
                            прибудет в&nbsp;кратчайшие сроки и&nbsp;выполнит все
                            необходимые работы&nbsp;&mdash; от&nbsp;планового
                            обслуживания до&nbsp;замены неисправных узлов.
                        </p>
                        <p class="ma-0">
                            Запись для получения услуги&nbsp;&mdash;
                            по&nbsp;телефону:
                        </p>
                        <a
                            class="phone mb-9 mb-md-11 d-block"
                            href="tel:+7 (923) 343-86-02"
                            >+7 (923) 343-86-02</a
                        >
                        <v-btn
                            class="main-button text-none font-weight-bold"
                            color="primary"
                            @click="
                ...
                <v-row class="align-center pb-9 flex-row flex-md-row-reverse">
                    <v-col cols="12" md="6">
                        ...
                        <p>
                            «KOMTRANS Group» имеет сеть сервисных центров и 20 выездных бригад. Специалисты компании всегда готовы выехать в любые места эксплуатации техники и провести ремонт, максимально сократив простои. При этом транспортировка техники не требуется.
                        </p>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-img
                            src="/img/services/truck.jpg"
                            alt="Выездной сервис в любую точку России"
                        />
                    </v-col>
                </v-row>
                ...
                <v-row class="block-padding">
                    ...
                    <v-col cols="12" md="4">
                        <v-card class="shadow-text-card">
                            ...
                            <p class="mb-0">
                                &laquo;KOMTRANS Group&raquo;&nbsp;&mdash;
                ...
                <v-row class="block-padding">
                    <v-col cols="12" md="6">
                        ...
                        <p class="mb-5 mb-md-8 mb-xl-11">
                            Специалист &laquo;KOMTRANS Group&raquo; проведёт
                    ...
                    <v-col class="arm__col__wrap" cols="12" md="6">
                        <div class="arm__wrap">
                            <img class="arm__photo" src="/img/arm_photo.png" />
                        </div>
                    </v-col>
                </v-row>
                        ...
                        <v-col
                            ...
                            :style="
                                $vuetify.breakpoint.xl
                                    ? ' flex: 1 0 20%; max-width: 20%;'
                                    : ''
                            "
                        >
                            <div
                                class="content-card_wrapper"
                                @click="
                                    $store.commit('onModalWindow', {
                                        title: 'Получить консультацию',
                                        btnName: 'Получить консультацию',
                ...
                <div class="order-works block-padding">
                    ...
                    <v-row>
                        <v-col cols="12" sm="6" md="3">
                            ...
                            >
                                <p
                                    class="card-title-number text-right secondary-text text-uppercase"
                                >
                                    01
                                </p>
                                <p
                                    class="card-title primary-text text-uppercase ma-0"
                                >
                        ...
                        <v-col cols="12" sm="6" md="3">
                            <v-card class="shadow-text-card">
                                ...
                                <p
                                    class="card-title primary-text text-uppercase ma-0"
                                >
                                    Формирование<br />и&nbsp;оплата счёта
                                </p>
                            </v-card>
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
        ...
        <FeedbackMan
            title="Оставьте заявку на сервисное обслуживание"
            content="Квалифицированный менеджер поможет с выбором услуги  и ответит на любой вопрос"
            btnTitle="Оставить заявку"
            formTitle="Оставить заявку"
            formBtnTitle="Отправить"
        />
    </div>
</template>
...
export default {
    ...
    head() {
        return {
            title: "Сервисное обслуживание грузовой техники Shacman у официального дилера",
            meta: [
                { charset: "utf-8" },
                {
                    hid: "description",
                    name: "description",
                    content:
                        "Специалисты компании КОМТРАНС производят диагностику грузовых автомобилей с выездом на место стоянки. 20 экипажей выездных бригад.",
                },
                {
                    hid: "keywords",
                    name: "keywords",
                    content:
                        "сервисное обслуживание грузовой техники shacman, ремонт, шакман, шахман",
                },
            ],
        };
    },
