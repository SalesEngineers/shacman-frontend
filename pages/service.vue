            ...
            <v-container>
                ...
                >
                    ...
                    <v-col cols="12" md="6">
                        <p class="mb-5 mb-md-8 mb-xl-11">
                            Транспортировка и&nbsp;отрыв спецтехники
                ...
                <v-row class="align-center pb-9 flex-row flex-md-row-reverse">
                    <v-col cols="12" md="6">
                        ...
                        <p>
                            &laquo;KOMTRANS Group&raquo; имеет 12&nbsp;сервисных
                            центров и&nbsp;20&nbsp;выездных бригад. Специалисты
                            компании всегда готовы выехать в&nbsp;любые места
                            эксплуатации техники и&nbsp;провести ремонт,
                            максимально сократив простои. При этом
                            транспортировка спецтехники не&nbsp;требуется.
                        </p>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-img
                    ...
                    <v-col cols="12" md="4">
                        <v-card class="shadow-text-card">
                            ...
                            <p class="mb-0">
                                ...
                                транспортировка спецтехники до&nbsp;сервисного
                                центра.
                            </p>
                        </v-card>
                    </v-col>
                    ...
                    <v-row class="align-center mb-8 mb-xl-16">
                        <v-col cols="12" md="6">
                            ...
                            <p>
                                ...
                                спецтехники и навесного оборудования. Занимаемся
        ...
        return {
            ...
            meta: [
                { charset: "utf-8" },
                {
                    ...
                    name: "description",
                    content:
                        "Специалисты компании КОМТРАНС производят диагностику грузовых автомобилей с выездом на место стоянки. 14 экипажей выездных бригад.",
                },
                {
                    hid: "keywords",
                    name: "keywords",
                    content:
                        "сервисное обслуживание спецтехники shacman, ремонт, шакман, шахман",
                },
            ],
        };
    },
