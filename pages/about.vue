            ...
            <v-row align="center" class="block-padding">
                ...
                <v-col cols="12" lg="6">
                    <div class="ml-xl-9 ml-lg-4">
                        ...
                        <p>
                            Компания основана в 2009 году и имеет большой опыт работы в сфере продажи грузовой техники. За время работы открыто более 20 филиалов по стране, собственные сервисные центры и склад запасных частей для грузовых автомобилей.
                        </p>
                        <p>
        ...
        return {
            ...
            meta: [
                { charset: "utf-8" },
                {
                    ...
                    name: "description",
                    content:
                        "Сегодня у нас есть филиалы более чем в 20 городах России, собственные станции сервисного обслуживания, большой штат высококлассных специалистов в разных сферах — продажи, ремонт, гарантия.",
                },
