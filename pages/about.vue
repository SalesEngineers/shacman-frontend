            ...
            <v-row align="center" class="block-padding">
                ...
                <v-col cols="12" lg="6">
                    <div class="ml-xl-9 ml-lg-4">
                        ...
                        <p>
                            Компания основана в 2009 году и имеет большой опыт
                            работы в сфере продажи спецтехники. За время работы
                            открыто 28 филиалов по стране, собственные сервисные
                            центры и склад запасных частей для спецтехники и
                            грузовых автомобилей.
                        </p>
                        <p>
                            На протяжении многих лет успешно реализуем
                            спецтехнику Shacman. Работа без посредников
                            позволяет быть уверенным в надежности сделки, а
                            также позволяет реализовать технику по самым
                            выгодным ценам на рынке. Благодаря тому, что техника
                            поступает к нам напрямую с завода, вы можете быть
                            уверены в ее качестве. Мы самостоятельно
                            осуществляем всю логистику по Китаю и России и
                            обеспечиваем прохождение таможни, это гарантирует
                            доставку техники в целостности и сохранности.
                        </p>
                    </div>
                </v-col>
            </v-row>
        ...
        return {
            ...
            meta: [
                { charset: "utf-8" },
                {
                    ...
                    name: "description",
                    content:
                        "Сегодня у нас есть филиалы в 27 городах России, собственные станции сервисного обслуживания, большой штат высококлассных специалистов в разных сферах — продажи, ремонт, гарантия.",
                },
