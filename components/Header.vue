<template>
    ...
    >
        <v-navigation-drawer class="mobile-menu" v-model="drawer" fixed temporary>
            <v-list-item>
                <v-list-item-icon>
            ...
            <v-list dense>
                <template v-for="item in mobMenu">
                    <v-list-item v-if="!item.is_href" :key="item.title" link :to="item.link">
                        <v-list-item-icon v-html="item.icon"></v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>{{ item.title }}</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                    <v-list-item v-else :key="item.title" link :href="item.link" target="_blank">
                        <v-list-item-icon v-html="item.icon"></v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>{{ item.title }}</v-list-item-title>
                        </v-list-item-content>
            ...
            <div class="upper-header">
                <div class="container">
                    <div v-if="dynamicContact" class="upper-header-content">
                        <div
                            class="d-none d-sm-block company-name"
                        >Официальный дилер Shacman в России</div>
                        <client-only>
                            ...
                            <div>
                                <span class="d-none d-sm-inline" v-if="dynamicContact.email">
            ...
            <div class="bottom-header">
                ...
                <v-expand-transition>
                    <div v-show="expand" @mouseleave="expand = false" class="catalog-menu_wrapper">
                        ...
                        <v-container
                            class="catalog-menu_container catalog-main_products menu-right_wrap"
                        >
                            <v-row v-if="spectech">
                                <v-col cols="10">
                                    <v-row>
