...
export const actions = {
  async loadCategories ({ commit }) {
    await axios.get(`https://api.xcmg-rf.ru/api/categories`)
    .then(r => r.data.data)
    .then(categories => {
  ...
  async loadSettings ({ commit }) {
    await axios.get(`https://api.xcmg-rf.ru/api/settings`)
    .then(r => r.data.data)
    .then(settings => {
  ...
  async loadContacts ({ commit }) {
    await axios.get(`https://api.xcmg-rf.ru/api/contacts`)
    .then(r => r.data.data)
    .then(contacts => {
  ...
  async loadArticles ({ commit }) {
    await axios.get(`https://api.xcmg-rf.ru/api/articles`)
    .then(r => r.data.data)
    .then(articles => {
